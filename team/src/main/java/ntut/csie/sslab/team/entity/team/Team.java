...
import ntut.csie.sslab.team.entity.team.event.*;
...
public class Team extends AggregateRoot<TeamId> {
    ...
    public void rename(TeamName newName) {
        requireNotNull("Team name", newName);
        ...
        addDomainEvent(new TeamRenamed(getId(), newName));
    }
