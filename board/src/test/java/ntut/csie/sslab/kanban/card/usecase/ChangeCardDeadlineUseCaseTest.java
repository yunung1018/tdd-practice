...
import ntut.csie.sslab.kanban.card.usecase.edit.deadline.in.ChangeCardDeadlineInput;
import ntut.csie.sslab.kanban.card.usecase.edit.deadline.in.ChangeCardDeadlineUseCase;
...
public class ChangeCardDeadlineUseCaseTest extends AbstractSpringBootJpaTest {
    ...
    public void should_succeed_when_change_card_deadline() {
        ...
        CqrsCommandOutput output = changeCardDeadlineUseCase.execute(input);
