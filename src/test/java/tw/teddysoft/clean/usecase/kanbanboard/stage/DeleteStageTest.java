...
//        assertEquals("To Do", util.getStageRepository().findAll().get(0).getTitle());
//        assertEquals("Doing", util.getStageRepository().findAll().get(1).getTitle());
//        assertEquals("Done", util.getStageRepository().findAll().get(2).getTitle());
//    }
//
//    private String getStageIdByName(String stageName){
//        for(Stage each : util.getStageRepository().findAll()){
//            if (each.getTitle().equals(stageName))
//                return each.getId();
//        }
...
//        assertEquals("To Do", util.getStageRepository().findAll().get(0).getTitle());
//        assertEquals("Done", util.getStageRepository().findAll().get(1).getTitle());
//    }
//
//
